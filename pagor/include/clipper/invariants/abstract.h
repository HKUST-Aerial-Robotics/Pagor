...
namespace clipper {
    ...
    public:
        ...
        virtual bool
        operator()(const Datum &ai, const Datum &aj, const Datum &bi, const Datum &bj, std::vector<double> &vec_c) = 0;

        virtual bool operator()(const Datum &ai, const Datum &aj, const Datum &bi, const Datum &bj,
                                const Covariance &cov_ai, const Covariance &cov_aj, const Covariance &cov_bi,
                                const Covariance &cov_bj,
                                std::vector<double> &vec_c) = 0;

        virtual int get_nb_num() = 0;
    };
